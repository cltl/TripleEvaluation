...
java -Xmx812m -cp ../lib/TripleEvaluation-1.0-jar-with-dependencies.jar vu.tripleevaluation.conversion.KybotOutputToTriples ../data/kyoto/11767.kaf.kybot.xml ../data/11767.kaf 0

java -Xmx812m -cp ../lib/TripleEvaluation-1.0-jar-with-dependencies.jar vu.tripleevaluation.conversion.KybotOutputToTriples ../data/kyoto/11767.kaf.kybot.xml ../data/11767.kaf 60
